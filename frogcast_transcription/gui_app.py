...
class AudioTranscriptionApp:
    def __init__(self, root):
        ...
        self.open_text_button = tk.Button(root, text="Open Text File", command=self.open_text_file)
        self.open_text_button.config(bg="light blue")  # Set button background color
        self.open_text_button.grid(row=6, column=1, columnspan=2, padx=10, pady=10)
